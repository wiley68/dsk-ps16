...
document.addEventListener("DOMContentLoaded", function(){
    ...
    if (btn_dskapi !== null){
        ...
        const dskapi_buy_buttons_submit = document.querySelectorAll("button[type='submit'][name='Submit']");
        ...
        btn_dskapi.addEventListener('click', event => {
            if (dskapi_button_status == 1){
                ...
                const el_dskapi_price1 = document.getElementById("our_price_display").innerHTML.replace(/[^\d.,-]/g, '');
