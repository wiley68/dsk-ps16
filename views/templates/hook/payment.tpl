...
<p class="payment_module">
    <a href="{$link->getModuleLink('dskpayment', 'payment')|escape:'html'}" class="cash" title="Банка ДСК покупки на Кредит" rel="nofollow">
        ...
        <br style="clear:both;" />
        <small>С избора си да финансирате покупката чрез Банка ДСК Вие декларирате, че сте запознат с Информацията относно обработването на лични данни на физически лица от Банка ДСК АД.</small>
        <br style="clear:both;" />
    </a>
</p>